...
- Tools: 52 total across ADB/logcat, device selection, file transfer/install,
...
30 tools total: ADB+logcat (6), JADX (4), androguard static (3), apktool (3),
Frida (10), mitmproxy network (4).
